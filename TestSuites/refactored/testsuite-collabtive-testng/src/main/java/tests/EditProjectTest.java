...
wait.until(ExpectedConditions.elementToBeClickable(By.id("end")));

			driver.findElement(By.id("end")).clear();
			driver.findElement(By.id("end")).sendKeys("24.12.2019");
			driver.findElement(By.linkText("Close")).click();
wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"form_addmyproject\"]/div/form/fieldset/div[6]/button[1]")));
