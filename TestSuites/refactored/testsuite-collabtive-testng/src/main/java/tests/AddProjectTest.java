...
wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id='contentwrapper']/div[1]/ul/li/a")));

			driver.findElement(By.xpath("//*[@id='contentwrapper']/div[1]/ul/li/a")).click();
wait.until(ExpectedConditions.elementToBeClickable(By.id("add_butn_myprojects")));
...
wait.until(ExpectedConditions.visibilityOfElementLocated(By.linkText(data[i][0])));
...
wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(budgetXpath)));
