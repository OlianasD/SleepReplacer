...
wait.until(ExpectedConditions.elementToBeClickable(By.xpath("html/body/div[1]/div[4]/form[2]/table/tbody/tr[3]/td[1]/input")));
		...
		assertTrue(driver.findElement(By.xpath("html/body/div[1]/div[4]/div")).getText().contains("Users added."));
		driver.findElement(By.linkText("home")).click();
wait.until(ExpectedConditions.elementToBeClickable(By.xpath("html/body/div[1]/div[4]/form[2]/table/tbody/tr[4]/td[1]/input")));
