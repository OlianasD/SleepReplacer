...
wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//input[@id='Entry_tagList'])[2]")));
...
wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("html/body/div[1]/div/div/div[3]/table/tbody/tr[1]/td[2]")));

		assertTrue(driver.findElement(By.xpath("html/body/div[1]/div/div/div[3]/table/tbody/tr[1]/td[2]")).getText().contains("0"));
		
wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("html/body/div[1]/div/div/div[3]/table/tbody/tr[3]/td[2]")));
