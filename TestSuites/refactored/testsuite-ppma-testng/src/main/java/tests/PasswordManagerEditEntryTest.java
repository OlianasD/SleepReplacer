...
wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/div/div/div[3]/table/tbody/tr["+data[i][6]+"]/td[1]/a")));

			driver.findElement(By.xpath("/html/body/div[1]/div/div/div[3]/table/tbody/tr["+data[i][6]+"]/td[1]/a")).click();
wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//input[@id='Entry_username'])[2]")));
...
wait.until(ExpectedConditions.elementToBeClickable(By.name("yt1")));

			driver.findElement(By.name("yt1")).click();
wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("html/body/div[1]/div/div/div[4]/table/tbody/tr["+data[i][6]+"]/td[2]")));
